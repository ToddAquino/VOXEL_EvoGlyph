...
[CreateAssetMenu(fileName = "GlyphPattern", menuName = "Glyph/Patterns")]
public class GlyphPattern : ScriptableObject
{
    [Header("Grid Settings")]
    public int width = 4;
    public int size = 16;
    private BitArray bts;
    private BitArray sqs;
    [SerializeField] public bool[] glyphPattern;
    [SerializeField] public int[] glyphSequence;
    private void Awake()
    {
        bts = new BitArray(glyphPattern);
        sqs = new BitArray(glyphPattern);
    }
}

#if UNITY_EDITOR
[CustomEditor(typeof(GlyphPattern))]
public class GlyphPatternEditor : Editor
{
